...
use crate::Raz_vm::operators::{apply_operator, apply_unary_operator};
...
pub enum Value {
    ...
    RazFunction(usize, String, Vec<usize>),
    String(String),
    Boolean(bool),
...
impl Value {
    pub fn to_string(&self, heap: &Heap) -> String {
        match self {
            ...
            Value::RazFunction(_, y, _) => {
                format!("Raz Function {} {:p}", y, self)
            }
    ...
    pub fn value_type(&self) -> ValueType {
        match self {
            ...
            Value::RazFunction(..) => ValueType::RazFunction,
